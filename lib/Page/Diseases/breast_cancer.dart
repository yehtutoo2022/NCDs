...
class _BreastCancerScreenState extends State<BreastCancerScreen> {
  ...
  void _toggleFavorite() {
    setState(() {
      ...
      if (isBookmarked) {
        ...
        Provider.of<FavoriteDataModel>(context, listen: false).addFavorite('Breast-Cancer');
      } else {
        // Remove item from favorites list
        Provider.of<FavoriteDataModel>(context, listen: false).removeFavorite('Breast-Cancer');
      }
    });
    String message =
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: Text(Locales.string(context, "breast-cancer")),
              background: Image.asset('assets/images/breast-cancer.jpg', fit: BoxFit.cover),
            ),
            actions: [
              IconButton(
                icon: Icon(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child: Text(
                          Locales.string(context, "breast-cancer-detail"),
                          style:  TextStyle(
                      ...
                      _buildExpansionTile(
                        ...
                        Locales.string(context, "breast-cancer-p1-title"),
                        'https://www.shutterstock.com/shutterstock/photos/377334331/display_1500/stock-vector-illustration-of-cancerous-breast-tumor-377334331.jpg',
                        Locales.string(context, "breast-cancer-p1-detail"),
                      ),
                      const SizedBox(height: 20.0),
                      //paragraph 2
                      _buildExpansionTile(
                        1,
                        //  Icons.fact_check,
                        Locales.string(context, "breast-cancer-p2-title"),
                        'https://www.shutterstock.com/image-illustration/breast-cancer-260nw-46841383.jpg',
                        Locales.string(context, "breast-cancer-p2-detail"),
                      ),
                      const SizedBox(height: 20.0),
                      //paragraph 3
                      _buildExpansionTile(
                        2,
                        //  Icons.checklist,
                        Locales.string(context, "breast-cancer-p3-title"),
                        'https://www.shutterstock.com/image-photo/woman-wearing-white-tank-top-600nw-719519635.jpg',
                        Locales.string(context, "breast-cancer-p3-detail"),
                      ),
                      const SizedBox(height: 20.0),
                      //p4
                      _buildExpansionTile(
                        3,
                        //  Icons.checklist,
                        Locales.string(context, "breast-cancer-p4-title"),
                        'https://www.shutterstock.com/image-photo/mammographer-guiding-patient-mammography-unit-600nw-2216446331.jpg',
                        Locales.string(context, "breast-cancer-p4-detail"),
                      ),
                      const SizedBox(height: 20.0),
                      //p5
                      _buildExpansionTile(
                        4,
                        //  Icons.checklist,
                        Locales.string(context, "breast-cancer-p5-title"),
                        'https://www.shutterstock.com/image-photo/rear-view-hispanic-young-woman-260nw-2203336583.jpg',
                        Locales.string(context, "breast-cancer-p5-detail"),
                      ),
                      const SizedBox(height: 20.0),
                      //p6
                      _buildExpansionTile(
                        5,
                        //  Icons.checklist,
                        Locales.string(context, "breast-cancer-p6-title"),
                        'https://www.shutterstock.com/image-photo/computer-screen-hospital-radiology-room-600nw-1942278202.jpg',
                        Locales.string(context, "breast-cancer-p6-detail"),
                      ),
                      const SizedBox(height: 20.0),
                    ],
                  ),
  ...
  Widget _buildExpansionTile(
    ...
    return ExpansionTile(
      ...
      initiallyExpanded: _isExpandedList[index], // Set the initial expansion state
    );
  }
