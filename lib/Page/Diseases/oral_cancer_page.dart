...
class OralCancerScreen extends StatefulWidget {
  const OralCancerScreen({super.key,});

  @override
  State<OralCancerScreen> createState() => _OralCancerScreenState();
}

class _OralCancerScreenState extends State<OralCancerScreen> {
  ...
  void _toggleFavorite() {
    setState(() {
      ...
      if (isBookmarked) {
        ...
        Provider.of<FavoriteDataModel>(context, listen: false).addFavorite('Oral-Cancer');
      } else {
        // Remove item from favorites list
        Provider.of<FavoriteDataModel>(context, listen: false).removeFavorite('Oral-Cancer');
      }
    });
    String message =
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: Text(Locales.string(context, "oral-cancer")),
              background: Image.asset('assets/images/oral-cancer.jpg', fit: BoxFit.cover),
            ),
            actions: [
              IconButton(
                icon: Icon(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child: Text(
                          Locales.string(context, "oral-cancer-detail"),
                          style:  TextStyle(
                      ...
                      _buildExpansionTile(
                        ...
                        Locales.string(context, "oral-cancer-p1-title"),
                        'https://www.shutterstock.com/shutterstock/photos/2236521813/display_1500/stock-photo-squamous-cell-carcinoma-of-tongue-oral-cancer-or-malignant-tumor-of-asian-male-patient-2236521813.jpg',
                        Locales.string(context, "oral-cancer-p1-detail"),
                      ),
                      const SizedBox(height: 20.0),
                      //paragraph 2
                      _buildExpansionTile(
                        1,
                        //  Icons.fact_check,
                        Locales.string(context, "oral-cancer-p2-title"),
                        'https://www.shutterstock.com/image-vector/man-oral-cancer-symptoms-on-260nw-1090764077.jpg',
                        Locales.string(context, "oral-cancer-p2-detail"),
                      ),
                      const SizedBox(height: 20.0),
                      //paragraph 3
                      _buildExpansionTile(
                        2,
                        //  Icons.checklist,
                        Locales.string(context, "oral-cancer-p3-title"),
                        'https://www.shutterstock.com/shutterstock/photos/1635485533/display_1500/stock-vector-vector-illustration-on-the-theme-of-oral-cancer-awareness-month-of-april-1635485533.jpg',
                        Locales.string(context, "oral-cancer-p3-detail"),
                      ),
                      const SizedBox(height: 20.0),
                    ],
                  ),
